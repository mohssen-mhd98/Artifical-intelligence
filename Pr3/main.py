...
def main():
    ...
    epsilon_values = [0.001, 0.0000001]
    lambda_values = [(0.33, 0.33, 0.33), (0.0001, 0.1999, 0.8), (0, 0.5, 0.5), (0.2, 0.2, 0.6)]
    for eps in epsilon_values:
        for l in lambda_values:
            print("Precision of model with eps = {},"
                  " and lambdas = (λ1={}, λ2={}, λ3={}) is:".format(eps, l[0], l[1], l[2]))
            precision = test_model_precision(poets_probs, hemistich, poets_name, l1=l[0],
                                   l2=l[1], l3=l[2], eps=eps)
            print('BackOff Precision:', precision, "\n")
...
def test_model_precision(model, hemistiches, poets_name, l1=0.001, l2=0.299, l3=0.7, eps=0.000001):
